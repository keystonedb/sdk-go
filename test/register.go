...
import (
	...
	"github.com/keystonedb/sdk-go/test/requirements/nested_property_loading"
	"github.com/keystonedb/sdk-go/test/requirements/nested_structs"
...
func init() {
	...
	reqs = append(reqs, &nested_property_loading.Requirement{})
